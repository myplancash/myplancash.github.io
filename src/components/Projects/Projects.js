...
const projectsData = [
  {
    title: 'Discover, an Event platform',
    class: 'item2',
    description: 'Discover a world of seamless shopping with our cutting-edge E-commerce app.',
    repoLink: 'https://github.com/myplancash/evently',
    liveDemoLink: 'https://evently-delta-gules.vercel.app',
  ...
  },
  {
    ...
    image: require('../../assets/images/project6-thumb.png'),
  }
];
